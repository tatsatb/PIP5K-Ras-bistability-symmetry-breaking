...
%--------------------------------------------------------------------------
    ...
    switch param.cell_type
         ...
         case 'pikl-:oscillator'            
            param.a = 0.1250; % Ras activation by Actin: p.a; change if needed
            param.m = 0.1500; % Ras inhibition by Myosin: p.m; change if needed
            param.Tmem = 0.0625; % membrane tension-mediated global negative feedback strength on Ras
    end
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
    switch param.cell_type
            ...
            case 'pikl-:oscillator'
                param.PIP5K_total = 0.0016;
                param.PIP5K_mem0  = 0.0014;
