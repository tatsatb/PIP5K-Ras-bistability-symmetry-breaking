%% function run_for_polaritynull
% generates kymographs for polarity null phenotype
...
%--------------------------------------------------------------------------
    ...
    switch param.cell_type
         ...
         case 'polarity null'
            ...
            % param.a = 0; % Ras activation by Actin
            % param.m = 0;  % Ras inhibition by Myosin
            param.m2 = 0;
            param.ac2 = 0;
...
%% SDE toolbox
    ...
    timeRange = t;
    problem = 'kymo2'; % name of the sde file
